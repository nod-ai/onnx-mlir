...
// CHECK-LABEL: @test_scalar_attr() -> !torch.tensor<[],f32>
// CHECK-DAG:    [[VAR_0_:%.+]] = torch.tensor.literal(dense<1.000000e+00> : tensor<f32>) : !torch.tensor<[],f32>
// CHECK-DAG:    [[VAR_1_:%.+]] = torch.tensor.literal(dense<2.000000e+00> : tensor<f32>) : !torch.tensor<[],f32>
}
...
// CHECK-LABEL: @test_single_value_attr() -> !torch.tensor<[1],f32>
// CHECK-DAG:    [[VAR_0_:%.+]] = torch.tensor.literal(dense<1.000000e+00> : tensor<1xf32>) : !torch.tensor<[1],f32>
// CHECK-DAG:    [[VAR_1_:%.+]] = torch.tensor.literal(dense<2.000000e+00> : tensor<1xf32>) : !torch.tensor<[1],f32>
}
...
// CHECK-LABEL: @test_splat_attr() -> !torch.tensor<[3],f32>
// CHECK-DAG:    [[VAR_0_:%.+]] = torch.tensor.literal(dense<1.000000e+00> : tensor<3xf32>) : !torch.tensor<[3],f32>
// CHECK-DAG:    [[VAR_1_:%.+]] = torch.tensor.literal(dense<2.000000e+00> : tensor<3xf32>) : !torch.tensor<[3],f32>
}
...
func.func @test_splat_nonsplat_attrs() -> tensor<3xf32> {
  ...
  %2 = "onnx.Add"(%0, %1) : (tensor<3xf32> , tensor<3xf32>) -> tensor<3xf32>
  "func.return"(%2) : (tensor<3xf32>) -> ()
// CHECK-LABEL: @test_splat_nonsplat_attrs() -> !torch.tensor<[3],f32>
// CHECK-DAG:    [[VAR_0_:%.+]] = torch.tensor.literal(dense<1.000000e+00> : tensor<3xf32>) : !torch.tensor<[3],f32>
// CHECK-DAG:    [[VAR_1_:%.+]] = torch.tensor.literal(dense<[0.000000e+00, 1.000000e+00, 2.000000e+00]> : tensor<3xf32>) : !torch.tensor<[3],f32>
}
